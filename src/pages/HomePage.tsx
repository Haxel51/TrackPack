      ...
      <main className="max-w-xl w-full mx-auto flex-grow px-6 py-8 flex flex-col justify-center space-y-8">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-white hover:bg-slate-50 border border-slate-200 hover:border-slate-300 text-[#0A1F44] font-bold p-5 rounded-2xl transition-all shadow-sm active:scale-[0.99] cursor-pointer flex items-center justify-between group min-h-[48px]"
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-xs font-semibold text-slate-600">Track, pay & collect waybills</p>
              </div>
            </div>
            <span className="text-slate-500 group-hover:text-[#F2A93B] text-lg font-bold transition-colors">→</span>
          </button>
          ...
          <div className="pt-3 border-t border-slate-200 flex flex-wrap items-center justify-center gap-3 text-sm text-slate-700">
            <span className="text-xs font-bold text-slate-600">Park Operations:</span>
