          ...
          {createdCode ? (
            ...
            <div className="text-center py-12 space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 p-6 rounded-xl text-left max-w-sm mx-auto space-y-4">
                ...
                <p className="text-sm font-bold text-blue-900 uppercase tracking-wider pt-2">Paystack Virtual Account</p>
                <p className="text-sm text-blue-800 mb-2">Transfer <strong>₦{(paymentDetails.amount / 100).toFixed(2)}</strong> to activate:</p>
                ...
                <div className="space-y-3 mt-4">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-2xl font-mono text-blue-900 tracking-wider">{paymentDetails.accountNumber}</p>
                  </div>
                  <div>
              ...
              <div className="bg-gray-50 border border-gray-200 p-4 rounded-xl text-left max-w-sm mx-auto space-y-2">
                <p className="text-sm font-bold text-gray-900 uppercase tracking-wider">How to Complete Payment:</p>
                <ul className="list-disc list-inside text-sm text-gray-700 space-y-2">
                  <li>
                    <strong>Direct Bank Transfer:</strong> Transfer ₦{(paymentDetails.amount / 100).toFixed(2)} from your mobile banking app to the virtual account shown above.
                  </li>
                  <li>
                    <strong>Cash at Counter:</strong> Hand ₦{(paymentDetails.amount / 100).toFixed(2)} cash to the staff. The staff will perform the transfer or use a POS machine on your behalf.
                  </li>
                </ul>
              </div>
