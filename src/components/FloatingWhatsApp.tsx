...
export function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end group">
      ...
      <div 
        className="mb-2 bg-navy text-white text-xs font-semibold px-3 py-1.5 rounded-xl shadow-lg border border-navy/20 flex items-center gap-1.5 opacity-90 group-hover:opacity-100 transition-opacity whitespace-nowrap animate-bounce"
      ...
      <a
        ...
        className="w-14 h-14 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full flex items-center justify-center shadow-xl hover:shadow-2xl hover:scale-105 active:scale-95 transition-all duration-200 relative group"
      >
