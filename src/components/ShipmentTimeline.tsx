                ...
                <div className="border-t border-slate-100 pt-5 space-y-3">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                    ...
                    <button
                      ...
                      className="bg-blue-50 hover:bg-blue-100 border border-blue-200 disabled:opacity-50 text-blue-950 font-extrabold px-3.5 py-3 rounded-xl text-xs transition-all cursor-pointer flex items-center justify-center gap-2 shadow-sm active:scale-95"
                    >
                      {isPdfDownloading ? (
                        <>
                  ...
                  <div className="flex justify-end pt-1">
                    <button
                      type="button"
                      onClick={() => setShowReceiptModal(false)}
                      className="w-full sm:w-auto bg-slate-100 hover:bg-slate-200 text-slate-700 font-extrabold px-6 py-2.5 rounded-xl text-xs transition-colors cursor-pointer"
                    >
                      Close Receipt
                    </button>
                  </div>
