...
export const SplashScreen: React.FC<SplashScreenProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_50%_40%,rgba(247, 148, 29,0.15)_0%,transparent_65%)]" />
      ...
      >
        ...
        <div className="relative z-20 flex flex-col items-center text-center px-4 max-w-sm">
          ...
          <div className="relative mb-5">
            <div className="absolute -inset-4 bg-orange-500/25 rounded-3xl blur-xl animate-pulse" />
            <div className="relative p-1 bg-gradient-to-b from-orange-400/40 to-transparent rounded-2xl shadow-2xl">
          ...
          {/* Slogan */}
          <div className="inline-block px-4 py-1.5 bg-[#0A1F44]/90 backdrop-blur-xs border border-orange-400/30 rounded-full shadow-lg">
            <p className="text-[#F7941D] font-extrabold text-xs sm:text-sm tracking-wider uppercase">
        ...
        <div className="relative z-20 w-full max-w-xs flex flex-col items-center space-y-2.5 pb-4">
          <div className="w-56 h-1.5 bg-[#051126]/90 rounded-full overflow-hidden relative shadow-inner border border-orange-400/30 backdrop-blur-xs">
            <div
              className={`h-full bg-gradient-to-r from-[#F7941D] via-orange-300 to-[#F7941D] rounded-full transition-all ease-out shadow-[0_0_12px_rgba(247, 148, 29,0.8)] ${progressWidth}`}
              style={{
                transitionDuration: `${duration - 600}ms`
              }}
            />
          </div>
          <span className="text-[11px] text-orange-200/80 font-medium tracking-wider uppercase">
            Loading System...
          </span>
        </div>
      </div>
